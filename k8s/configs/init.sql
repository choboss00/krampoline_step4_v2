...
INSERT INTO users (created_at, first_name, last_name, email, password, country, introduction, birth_date, profile_image, role, phone) VALUES
 (NOW(), 'John', 'Doe', 'test1@example.com', '{bcrypt}$2a$10$8H0OT8wgtALJkig6fmypi.Y7jzI5Y7W9PGgRKqnVeS2cLWGifwHF2', 'UA', 'Hello, I am John.', '1998-01-01', null, 'MENTOR', '010-0000-0000'),
 (NOW(), 'Alice', 'Smith', 'test2@example.com', '{bcrypt}$2a$10$8H0OT8wgtALJkig6fmypi.Y7jzI5Y7W9PGgRKqnVeS2cLWGifwHF2', 'UA', 'I love painting.', '1998-01-01', null, 'MENTOR', '010-0000-0000'),
 (NOW(), 'Admin', 'Admin', 'test3@example.com', '{bcrypt}$2a$10$8H0OT8wgtALJkig6fmypi.Y7jzI5Y7W9PGgRKqnVeS2cLWGifwHF2', 'UA', 'I am an admin user.', '1988-01-01', null, 'MENTEE', '010-0000-0000'),
 (NOW(), 'Jane', 'Smith', 'test4@example.com', '{bcrypt}$2a$10$8H0OT8wgtALJkig6fmypi.Y7jzI5Y7W9PGgRKqnVeS2cLWGifwHF2', 'UA', 'I love coding.', '1993-01-01', null, 'MENTEE', '010-0000-0000'),
 (NOW(), 'Adccczczmin', 'qwdasd', 'test5@example.com', '{bcrypt}$2a$10$8H0OT8wgtALJkig6fmypi.Y7jzI5Y7W9PGgRKqnVeS2cLWGifwHF2', 'UA', 'I am the qwdad.', '1988-01-01', null, 'MENTEE', '010-0000-0000'),
 (NOW(), 'adadad', 'adaddddd', 'test6@example.com', '{bcrypt}$2a$10$8H0OT8wgtALJkig6fmypi.Y7jzI5Y7W9PGgRKqnVeS2cLWGifwHF2', 'UA', 'I am the adadad.', '1988-01-01', null, 'MENTEE', '010-0000-0000'),
(NOW(), 'admin', 'admin', 'admin@example.com', '{bcrypt}$2a$10$8H0OT8wgtALJkig6fmypi.Y7jzI5Y7W9PGgRKqnVeS2cLWGifwHF2', 'UA', 'I am the admin.', '1988-01-01', null, 'ADMIN', '010-0000-0000');
